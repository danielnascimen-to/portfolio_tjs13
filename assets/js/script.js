...
async function getAboutGitHub() {
    try {
      ...
      <!-- Imagem da Seção About -->
        ...
        <p>
          Vamos conectar? Explore meus repositórios no GitHub ou baixe meu currículo abaixo para detalhes sobre minha trajetória técnica. <strong>Estou em busca da minha primeira oportunidade como Dev!</strong>
        </p>
